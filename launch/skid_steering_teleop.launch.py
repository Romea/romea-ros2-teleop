...
def launch_setup(context, *args, **kwargs):
    ...
    if output_message_type == "romea_mobile_base_msgs/SkidSteeringCommand":
        output_topic = "cmd_skid_steering"
    ...
    maximal_longitudinal_speed = speed_command_info["maximal_speed"]
    maximal_angular_speed = 2 * maximal_longitudinal_speed / track
    ...
    teleop = Node(
        ...
        parameters=[
            ...
            {"cmd_range.maximal_linear_speed.turbo_mode": maximal_longitudinal_speed},
