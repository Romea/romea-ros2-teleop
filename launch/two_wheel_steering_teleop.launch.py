...
def launch_setup(context, *args, **kwargs):
    ...
    wheelbase = base_info["geometry"]["axles_distance"]

    if "front_wheels_steering_control" in base_info :
        track = base_info["geometry"]["front_axle"]["wheels_distance"]
        wheels_steering_control_info = base_info["front_wheels_steering_control"]

    if "rear_wheels_steering_control" in base_info :
        track = base_info["geometry"]["rear_axle"]["wheels_distance"]
        wheels_steering_control_info = base_info["rear_wheels_steering_control"]

    wheels_steering_command_info = wheels_steering_control_info["command"]
    maximal_wheel_angle = wheels_steering_command_info["maximal_angle"]
