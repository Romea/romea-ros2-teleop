...
def launch_setup(context, *args, **kwargs):
    ...
    if output_message_type == "romea_mobile_base_msgs/TwoAxleSteeringCommand":
       output_topic = "cmd_two_axle_steering"

    if output_message_type == "four_wheel_steering_msgs/FourWheelSteering":
       output_topic = "cmd_4ws"
    ...
    axles_steering_control_info = base_info["axles_steering_control"]
    axles_steering_command_info = axles_steering_control_info["command"]
    maximal_steering_angle = axles_steering_command_info["maximal_angle"]
